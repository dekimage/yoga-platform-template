    ...
    return [
      {
        ...
        description: "A gentle 20-minute flow to start your day with energy and mindfulness.",
        bunnyVideoId: "video1",
      ...
      },
      {
        ...
        description: "Build strength and endurance with this challenging 45-minute power yoga session.",
        bunnyVideoId: "video2",
        thumbnail: "/placeholder.svg?height=200&width=300",
        category: "Power",
      ...
      },
      {
        ...
        description: "Wind down with this peaceful 30-minute restorative practice perfect for bedtime.",
        bunnyVideoId: "video3",
        thumbnail: "/placeholder.svg?height=200&width=300",
